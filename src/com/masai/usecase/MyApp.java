						...
						case 2:
							...
							try {
								...
								case 1:
									...
									String message1=adminDao.updateCustomerFirstName(acc, fname);
									System.out.println("");
								...
								case 2:
									...
									String message2=adminDao.updateCustomerLastName(acc, lname);
									System.out.println("");
								...
								case 3:
									...
									String message3=adminDao.updateCustomerMobileNo(acc, mobile);
									System.out.println("");
								...
								case 4:
									...
									String message4=adminDao.updateCustomerEmail(acc, email);
									System.out.println("");
								...
								case 5:
									...
									String message5=adminDao.updateCustomerUserName(acc, username);
									System.out.println("");
								...
								case 6:
									...
									String pass=sc.next();
									String message6=adminDao.updateCustomerPassword(acc, pass);
									System.out.println("");
